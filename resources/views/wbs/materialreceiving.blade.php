...
@section('content')
    ...
    @foreach ($userProgramAccess as $access)
        @if ($access->program_code == Config::get('constants.MODULE_CODE_MATRVC'))  <!-- Please update "2001" depending on the corresponding program_code -->
                    ...
                    <div class="portlet-body">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control clear clearinv input-sm date-picker" data-date-format="yyyy-mm-dd" size="16" type="text" name="receivingdate" id="receivingdate"/>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control clear clearinv input-sm date-picker" data-date-format="yyyy-mm-dd" size="16" type="text" name="invoicedate" id="invoicedate" disabled="disable"/>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <a href="{{url('/materialreceiving')}}" class="btn red input-sm" id="btn_cancel" <?php echo($state); ?> >
...
<script type="text/javascript">
    ...
    var getLatestRecordURL = '{{url("/wbsgetlatestmr")}}';
    var checkInvoiceURL = '{{url("/wbsmrpostinvoicenum")}}';
    var searchURL = '{{url("/wbsmrsearch")}}';
    var lookItemURL = '{{url("/wbsmrlookitem")}}';
    var barcodeURL = '{{url("/wbsmrprintbarcode")}}';
    var printURL = '{{url("/wbsmrprintmr")}}'
    var appToIQCURL = '{{url("/wbsmrprintiqc")}}';
    var receivieAllURL = "{{ url('/wbsmrreceiveall') }}";
    var navigateURL = '{{url("/wbsnavigate")}}';
    var getItemsURL = "{{url('/wbsmrgetitems')}}";
    var getItemDataURL = "{{url('/wbsmrgetitemdata')}}";
    var getPackageURL = "{{url('/wbsmrgetpackage')}}";
    var singleBatchURL = "{{url('/wbsmrsinglebatchitem')}}";
    var checkIfNotForIQCURL = "{{url('/wbsmrcheckifnotforiqc')}}";
    var saveURL = '{{url("/wbsmrsave")}}';
    var mrNumberURL = '{{url("/wbsmrnumber")}}';
    var deteleBatchURL = '{{url("/wbsmrdeletebatch")}}';
    var cancelInvoiceURL = '{{url("/wbsmrcanvelinvoice")}}';
    var refreshInvoiceURL = "{{ url('/wbsmr-refresh') }}";
    var supplierURL = "{{url('/getReceivingSupplier')}}";
    var access_state = "{{ $pgaccess }}";
    var pcode = "{{ $pgcode }}";
</script>
<script src="{{ asset(config('constants.PUBLIC_PATH').'assets/global/scripts/material_receiving.js') }}" type="text/javascript"></script>
@endpush
